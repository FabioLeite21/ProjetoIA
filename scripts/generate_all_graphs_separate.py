#!/usr/bin/env python3
"""
Script para gerar TODOS os grafos com dados EEG em arquivos .gml SEPARADOS.
...
def generate_all_graphs_separate_gml():
    """Gera todos os grafos com dados EEG em arquivos .gml separados."""
    
    print("=== GERAÇÃO DE GRAFOS EM ARQUIVOS .GML SEPARADOS ===")
    print("Cada trial terá 3 arquivos:")
    print("  • grafo_principal.gml (eye-tracking + EEG)")
    print("  • grafo_principal_features.gml (matriz de features)")
    print("  • grafo_principal_adjacency.gml (matriz de adjacência)")
    print()
    ...
    print("Para cada trial, foram criados:")
...
if __name__ == "__main__":
    generate_all_graphs_separate_gml()
